'use strict';
// Q2 (rev3): the heat-capacity window at dry 1400 kg. Peaks for empty / half / full hold /
...
const DRY = Number(process.env.DRY) || 1400;
const P = {
  flight: { dry_mass_kg: DRY, fuel_capacity_kg: 860, thrust_n: 57000, fuel_burn_kgs: 13.0 },
  ...
  landing: { soft_landing_ms: 5, damage_per_ms_over: 6, no_gear_multiplier: 2,
             ...
             parachute_drag_coefficient: 1.8, descent_speed_full_hold_ms: 3.64 },
};
